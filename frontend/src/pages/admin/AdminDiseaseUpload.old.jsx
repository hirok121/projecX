      ...
      <Container maxWidth="xl" sx={{ py: 6 }}>
        ...
        >
          ...
          >
            ...
            <Typography variant="body2" sx={{ color: "#6B7280", mt: 0.5, fontWeight: 400 }}>
              {editingDisease 
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  error={diseaseForm.name.length > 200}
                  sx={{
                    "& .MuiOutlinedInput-root": {
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth required>
                  ...
                  <Typography variant="caption" sx={{ mt: 0.5, color: "#6B7280", ml: 1.5 }}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  error={diseaseForm.blog_link.length > 500}
                  sx={{
                    "& .MuiOutlinedInput-root": {
                      "&.Mui-focused fieldset": { borderColor: "#10B981" },
                    },
              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  >
                    Select the diagnostic modalities that can be used to classify this disease. 
                    Click to toggle selection.
                  </Typography>
                  <Box display="flex" gap={1.5} flexWrap="wrap">
                    {MODALITY_OPTIONS.map((modality) => {
                      const isSelected = (diseaseForm.available_modalities || []).includes(modality);
                      return (
                        <Chip
                          key={modality}
                          label={modality}
                          onClick={() => handleModalityToggle(modality)}
                          icon={isSelected ? <CheckCircle sx={{ fontSize: 18 }} /> : undefined}
                          sx={{
                            px: 1.5,
                            py: 2.5,
                            fontSize: "0.95rem",
                  ...
                  {diseaseForm.available_modalities?.length === 0 && (
                    <Typography
                      variant="caption"
                ...
                <Grid item xs={12}>
                  ...
                  >
                    <Typography variant="body2" sx={{ color: "#92400E" }}>
                      <strong>Note:</strong> Editing this disease will affect all associated classifiers and predictions.
                    </Typography>
                  </Box>
                </Grid>
              )}
          ...
          <DialogActions sx={{ p: 3, backgroundColor: "#F9FAFB", gap: 1 }}>
            <Button 
              onClick={() => setDiseaseDialogOpen(false)}
              sx={{ 
                color: "#6B7280",
